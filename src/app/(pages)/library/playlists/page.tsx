  ...
  return (
    <div className='mb-36'>
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm">{playlists.length} Playlists</span>
      </div>
          ...
          >
            <div className="flex items-center justify-start gap-3 truncate">
              <img
                ...
                height={60}
                width={60}
                src={playlist.image[2].url || playlist?.image[2]?.url}
              />
              <div className='w-full truncate'>
                <h1 className="text-xl font-semibold truncate">{playlist.name}</h1>
